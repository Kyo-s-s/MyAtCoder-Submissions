...
//     auto dfs = [&](auto dfs, string S, bool isO) -> bool {
//         if (isO) {
//             bool res = false;
//             rep(i, N) if (S[i] == '-') {
//                 string T = S;
//                 T[i] = 'o';
//                 if (0 <= i - 1 && T[i - 1] == 'o') continue;
//                 if (i + 1 < N && T[i + 1] == 'o') continue;
//                 res |= dfs(dfs, T, false);
//             }
//             return res;
//         } else {
...
//                 string T = S;
//                 T[i] = 'x';
//                 if (0 <= i - 1 && T[i - 1] == 'x') continue;
//                 if (i + 1 < N && T[i + 1] == 'x') continue;
//                 res &= dfs(dfs, T, true);
//             }
//             return res;
//         } 
...
int main() {
    ...
    auto TA = [](bool isT) -> void {
        OUT(isT ? "Takahashi" : "Aoki");
        exit(0);
    };
