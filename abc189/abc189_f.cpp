...
struct Add_M_pair {
    ...
    static T op(T a, T b){ return {a.a + b.a, a.b + b.b}; }
};
...
int main(){
    ...
    vector<Add_M_pair::T> v(N, Add_M_pair::e());
    Segtree<Add_M_pair> seg(v);
    ...
    auto ans = U.b / (1.0 - U.a);

    if(ans != INFINITY) OUT(ans);
    else OUT(-1);
