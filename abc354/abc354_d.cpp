...
int main() {
    ...
    vector<ll> gu = {x, s, o, s, x, s, o, s, x, s, o, s, x, s, o, s};
    vector<ll> ki = {s, x, s, o, s, x, s, o, s, x, s, o, s, x, s, o};
    ...
    ll ans = nw * (guk + kik) + [&]() -> ll {
        if (B + nw * 2LL == D) return 0;
        return (B % 2 == 0) ? guk: kik;
    }();
