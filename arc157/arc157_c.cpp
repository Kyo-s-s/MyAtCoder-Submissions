...
int main() {
    ...
    rep(h, H) rep(w, W) {
        if (h + 1 < H) {
            dp[h + 1][w] += ((S[h][w] == 'Y' && S[h + 1][w] == 'Y') ? en.nCk(h + w, h) : 0) + dp[h][w];
        }
        if (w + 1 < W) {
            dp[h][w + 1] += ((S[h][w] == 'Y' && S[h][w + 1] == 'Y') ? en.nCk(h + w, w) : 0) + dp[h][w];
        }
    }
    ...
    rep(h, H) rep(w, W) {
        if (h + 1 < H && S[h][w] == 'Y' && S[h + 1][w] == 'Y') {
            Mint a = en.nCk(h + w, h) * en.nCk(H + W - h - w - 3, H - h - 2);
            Mint b = dp[h][w] * en.nCk(H + W - h - w - 3, H - h - 2);
            ans += a + two * b;
        }
        if (w + 1 < W && S[h][w] == 'Y' && S[h][w + 1] == 'Y') {
            Mint a = en.nCk(h + w, w) * en.nCk(H + W - h - w - 3, W - w - 2);
            Mint b = dp[h][w] * en.nCk(H + W - h - w - 3, W - w - 2);
            ans += a + two * b;
        }
    }
